...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NinjutsuService", function() { return NinjutsuService; });
...
let NinjutsuService = class NinjutsuService {
    constructor(http) {
        this.http = http;
        this.data = null;
    }
    load() {
        ...
        return new Promise(resolve => {
            this.http.get("assets/ninjutsu.json")
                .subscribe(data => {
                this.data = data;
                resolve(this.data);
            });
...
NinjutsuService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
NinjutsuService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
