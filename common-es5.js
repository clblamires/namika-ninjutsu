...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /*! exports provided: NinjutsuService */

  /***/
  function srcAppNinjutsuServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NinjutsuService", function () {
      return NinjutsuService;
    });
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function NinjutsuService(http) {
        _classCallCheck(this, NinjutsuService);

        this.http = http;
        this.data = null;
      }

      _createClass(NinjutsuService, [{
        key: "load",
        value: function load() {
          var _this = this;
          ...
          return new Promise(function (resolve) {
            _this.http.get("assets/ninjutsu.json").subscribe(function (data) {
              _this.data = data;
              resolve(_this.data);
            });
          });
        ...
        key: "getOneNinjutsu",
        value: function getOneNinjutsu(id) {
          var n = "NOT FOUND";
    ...
    NinjutsuService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    NinjutsuService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]])], NinjutsuService);
    /***/
  }
}]);
